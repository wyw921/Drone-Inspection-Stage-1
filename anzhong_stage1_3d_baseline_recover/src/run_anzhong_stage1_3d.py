"""Convenience runner for the restored Anzhong coarse-model baseline.
...
def main() -> None:
    cli = argparse.ArgumentParser(description="Run the restored Anzhong stage-1 baseline prototype.")
    cli.add_argument("--coarse-model-dir", type=Path, default=DEFAULT_COARSE_MODEL_DIR)
    cli.add_argument(
        "--output-dir",
        type=Path,
        default=Path("outputs/anzhong_stage1_3d_baseline_recover"),
    )
